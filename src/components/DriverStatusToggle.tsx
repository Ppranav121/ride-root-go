...
const DriverStatusToggle: React.FC<DriverStatusToggleProps> = ({
  ...
  return <motion.div className="relative rounded-xl overflow-hidden" initial={{
    opacity: 0,
    y: 10
  }} animate={{
    opacity: 1,
    ...
    duration: 0.4
      ...
      <div className={`rounded-xl bg-white shadow-lg border border-gray-100 p-5 overflow-hidden`}>
        <div className="absolute inset-0 opacity-10">
          {isOnline ? <div className="absolute inset-0 bg-gradient-to-r from-rideroot-primary/80 to-rideroot-accent/80" /> : <div className="absolute inset-0 bg-gradient-to-r from-indigo-300/80 to-blue-300/80" />}
        </div>
        ...
        delay: 0.2
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={handleReturnToDashboard}>
