...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(({
  ...
  ...props
    ...
    side
      ...
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 bg-gray-100 opacity-80 ring-offset-background transition-opacity hover:opacity-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
        <X size={18} />
