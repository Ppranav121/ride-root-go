...
const BookRide: React.FC = () => {
  ...
  return <div className="flex flex-col h-screen bg-rideroot-lightGrey">
      ...
      <div className="flex-1 relative">
        ...
        <motion.div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-xl" style={{
        maxHeight: panelExpanded ? "70vh" : "90px"
      }} initial={{
        y: 100,
        opacity: 0
      }} animate={{
        ...
        ease: "easeOut"
          ...
          <ScrollArea className={`${panelExpanded ? 'h-[70vh]' : 'h-[90px]'} w-full overflow-hidden`}>
            <div className={`${panelExpanded ? 'pt-6' : 'pt-3 px-4'}`}>
              {!panelExpanded ? <div className="flex items-center">
                  ...
                  <LocationSearchContainer pickupLocation={pickupLocation} dropoffLocation={dropoffLocation} onPickupChange={setPickupLocation} onDropoffChange={setDropoffLocation} />
                  
                  <RideBookingForm pickupLocation={pickupLocation} dropoffLocation={dropoffLocation} />
                </>}
            </div>
          </ScrollArea>
        </motion.div>
